...
(deftest test-bump-version
  ...
  (let [bump-version (partial release-4d/wrap-with-4d-bump-version
    ...
    (is (= "1.1.0-1" (bump-version "1.1.0-1-SNAPSHOT" :release)))
    (is (= "1.1.0" (bump-version "1.1.0-1" :release)))
    (is (= "1.1.0-2-SNAPSHOT" (bump-version "1.1.0-1-SNAPSHOT")))
    (is (= "1.1.0-2-SNAPSHOT" (bump-version "1.1.0-1")))
    (is (= "1.1.1-2-SNAPSHOT" (bump-version "1.1.1-1-SNAPSHOT" :qualifier)))
    (is (= "1.1.1-2-SNAPSHOT" (bump-version "1.1.1-1" :qualifier)))
    (is (= "1.1.1-SNAPSHOT" (bump-version "1.1.0-1-SNAPSHOT" :patch)))
    (is (= "1.1.1-SNAPSHOT" (bump-version "1.1.0-1" :patch)))
    (is (= "1.3.0-SNAPSHOT" (bump-version "1.2.0-1-SNAPSHOT" :minor)))
    (is (= "1.3.0-SNAPSHOT" (bump-version "1.2.0-1" :minor)))
    (is (= "2.0.0-SNAPSHOT" (bump-version "1.2.0-1-SNAPSHOT" :major)))
    (is (= "2.0.0-SNAPSHOT" (bump-version "1.2.0-1" :major)))

    (is (= "1.1.0.0-1" (bump-version "1.1.0.0-1-SNAPSHOT" :release)))
    (is (= "1.1.0.0" (bump-version "1.1.0.0-1" :release)))
    (is (= "1.1.0.0-2-SNAPSHOT" (bump-version "1.1.0.0-1-SNAPSHOT")))
    (is (= "1.1.0.0-2-SNAPSHOT" (bump-version "1.1.0.0-1")))
    (is (= "1.1.1.1-2-SNAPSHOT" (bump-version "1.1.1.1-1-SNAPSHOT" :qualifier)))
    (is (= "1.1.1.1-2-SNAPSHOT" (bump-version "1.1.1.1-1" :qualifier)))
    (is (= "1.1.0.1-SNAPSHOT" (bump-version "1.1.0.0-1-SNAPSHOT" :build)))
    (is (= "1.1.0.1-SNAPSHOT" (bump-version "1.1.0.0-1" :build)))
    (is (= "1.1.2.0-SNAPSHOT" (bump-version "1.1.1.1-1-SNAPSHOT" :patch)))
    (is (= "1.1.2.0-SNAPSHOT" (bump-version "1.1.1.1-1" :patch)))
    (is (= "1.3.0.0-SNAPSHOT" (bump-version "1.2.3.4-1-SNAPSHOT" :minor)))
    (is (= "1.3.0.0-SNAPSHOT" (bump-version "1.2.3.4-1" :minor)))
    (is (= "2.0.0.0-SNAPSHOT" (bump-version "1.6.3.4-1-SNAPSHOT" :major)))
    (is (= "2.0.0.0-SNAPSHOT" (bump-version "1.6.3.4-1" :major))))))
